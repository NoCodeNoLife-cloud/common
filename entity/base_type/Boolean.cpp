...
auto Boolean::compareTo(const Boolean& other) const -> int { return value_ - other.value_; }
...
bool Boolean::equals(const Boolean& other) const { return value_ == other.value_; }
