...
bool Byte::equals(const Byte& other) const { return value_ == other.value_; }
...
auto Byte::compareTo(const Byte& other) const -> int { return (value_ > other.value_) - (value_ < other.value_); }
