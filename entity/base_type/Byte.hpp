...
namespace common::entity::base_type
{
	...
	/// The Byte class provides several methods for performing operations on a byte by a Byte object, including methods for adding, subtracting, multiplying, and dividing two Byte objects.
	/// There are also methods for determining the absolute value, as well as methods for comparing two Byte objects.
	class Byte final : public Object, public interface::Comparable<Byte>
	{
	public:
