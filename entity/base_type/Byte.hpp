...
class Byte final : public Object,
                   public interface::Comparable<Byte>
{
public:
 ...
 */
inline auto std::formatter<common::entity::base_type::Byte>::format(const common::entity::base_type::Byte& content, format_context& ctx) -> back_insert_iterator<_Fmt_buffer<char>> { return std::format_to(ctx.out(), "{}", content.value_); }

inline auto operator<<(std::ostream& os, const common::entity::base_type::Byte& content) -> std::ostream& { return os << std::format("{}", content); }
#endif // BYTE_HPP
