...
/// false.
bool Character::equals(const Character& other) const { return value_ == other.value_; }
...
auto Character::compareTo(const Character& other) const -> int { return value_ - other.value_; }
...
auto Character::toUpperCase(const char c) -> int { return std::toupper(c); }
...
auto Character::toLowerCase(const char c) -> int { return std::tolower(c); }
