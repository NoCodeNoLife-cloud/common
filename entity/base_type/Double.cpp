...
/// false.
bool Double::equals(const Double& other) const { return value_ == other.value_; }
...
auto Double::compareTo(const Double& other) const -> int { return (value_ > other.value_) - (value_ < other.value_); }
