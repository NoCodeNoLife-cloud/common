...
bool Float::equals(const Float& other) const { return value_ == other.value_; }
...
auto Float::compareTo(const Float& other) const -> int { return (value_ > other.value_) - (value_ < other.value_); }
