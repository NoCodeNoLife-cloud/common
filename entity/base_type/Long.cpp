...
Long::operator long() const { return static_cast<long>(value_); }
...
bool Long::equals(const Long& other) const { return value_ == other.value_; }
...
auto Long::compareTo(const Long& other) const -> int { return (value_ > other.value_) - (value_ < other.value_); }
