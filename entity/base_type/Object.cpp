...
auto Object::clone() const -> std::unique_ptr<Object> { return std::make_unique<Object>(Object(*this)); }
...
auto Object::hashCode() const -> size_t { return std::hash<const void*>{}(this); }
