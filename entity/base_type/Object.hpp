 ...
 */
inline auto std::formatter<common::entity::base_type::Object>::format([[maybe_unused]] const common::entity::base_type::Object& content, format_context& ctx) -> back_insert_iterator<_Fmt_buffer<char>> { return std::format_to(ctx.out(), "Object{{}}", ""); }

inline auto operator<<(std::ostream& os, const common::entity::base_type::Object& object) -> std::ostream& { return os << std::format("{}", object); }
#endif // OBJECT_HPP
