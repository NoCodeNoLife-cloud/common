...
namespace common::entity::base_type
{
	...
	/// zero if the strings are equal, and positive if this String object is lexicographically greater than the specified String object.
	...
	/// \return A new String object with all occurrences of the specified character replaced with the specified replacement character.
	...
	/// \throws std::out_of_range If the range is invalid (i.e. beginIndex < 0, endIndex > data.size(), or beginIndex > endIndex).
	...
	/// \return A new String object with all occurrences of the regular expression replaced with the specified replacement string.
	...
	/// \param regex The regular expression to match against.
	/// \param replacement The string to replace with.
	/// \return A new String object with the first occurrence of the regular expression replaced with the specified replacement string.
	...
	/// \return True if the specified subregion of this string is equal to the specified subregion of the given string, false otherwise.
