...
auto String::concat(const String& str) const -> String { return String(data_ + str.data_); }
...
/// String object.
auto String::compareTo(const String& anotherString) const -> int { return data_.compare(anotherString.data_); }
...
auto String::valueOf(const int i) -> String { return String(std::to_string(i)); }
...
auto String::valueOf(const long l) -> String { return String(std::to_string(l)); }
...
auto String::toString() const -> std::string { return std::format("{}", *this); }
} // namespace common::entity::base_type
