 ...
 */
inline auto std::formatter<common::entity::base_type::String>::format(const common::entity::base_type::String& content, format_context& ctx) -> back_insert_iterator<_Fmt_buffer<char>> { return std::format_to(ctx.out(), "String{{data: {}}}", content.data_); }

inline auto operator<<(std::ostream& os, const common::entity::base_type::String& content) -> std::ostream& { return os << std::format("{}", content); }
#endif // STRING_HPP
