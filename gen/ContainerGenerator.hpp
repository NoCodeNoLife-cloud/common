...
#ifndef CONTAINERGENERATOR_HPP
#define CONTAINERGENERATOR_HPP
#include <array>
#include <deque>
...
/// \return a random value in [minValue, maxValue].
template <typename T> auto ContainerGenerator::Check(T minValue, T maxValue, const int size) -> void { if (minValue > maxValue || size < 0) { throw std::invalid_argument("ContainerGenerator: invalid parameters"); } }
} // namespace common::gen
#endif // CONTAINERGENERATOR_HPP
