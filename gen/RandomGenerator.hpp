...
namespace common::gen
{
	...
	public:
		template <typename T>
		static auto getUniformIntDistributionValue(T min, T max) -> T;

		template <typename T>
		static auto getUniformRealDistributionValue(T min, T max) -> T;

		template <typename T>
		static auto getNormalDistribution(T mean, T stddev) -> T;

		template <typename T>
		static auto getPoissonDistribution(T mean) -> T;

		template <typename T>
		static auto getDiscreteDistribution(T min, T max) -> T;

		template <typename T>
		static auto getExponentialDistribution(T lambda) -> T;
	...
	template <typename T>
	auto RandomGenerator::getUniformIntDistributionValue(T min, T max) -> T
	{
	...
	template <typename T>
	auto RandomGenerator::getUniformRealDistributionValue(T min, T max) -> T
	{
	...
	template <typename T>
	auto RandomGenerator::getNormalDistribution(T mean, T stddev) -> T
	{
	...
	template <typename T>
	auto RandomGenerator::getPoissonDistribution(T mean) -> T
	{
	...
	template <typename T>
	auto RandomGenerator::getDiscreteDistribution(T min, T max) -> T
	{
		std::uniform_int_distribution<T> dist(min, max);
		return dist(gen_);
	}
	...
	template <typename T>
	auto RandomGenerator::getExponentialDistribution(T lambda) -> T
	{
