...
auto AbstractOutputStream::write(const std::vector<char>& buffer) -> void {
...
auto AbstractOutputStream::write(const std::vector<char>& buffer, const size_t offset, const size_t len) -> void {
