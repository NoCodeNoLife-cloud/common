...
class AbstractWriter abstract : public interface::IfaceCloseable,
                                public interface::IfaceFlushable,
                                interface::IfaceAppendable<AbstractWriter>
{
public:
	AbstractWriter();
	...
	virtual void write(std::vector<char>& cBuf, size_t off, size_t len) = 0;
	virtual auto write(std::vector<char>& cBuf) -> void;
