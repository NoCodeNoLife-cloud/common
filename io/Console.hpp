...
class Console final : public interface::Flushable
{
public:
 ...
 */
template <typename... Args> auto Console::format(const std::string& fmt, Args... args) -> void { std::cout << std::vformat(fmt, std::make_format_args(args...)); }
 ...
 * \param args The arguments to be formatted according to the format string.
 */
template <typename... Args> auto Console::printf(const std::string& fmt, Args... args) -> void { format(fmt, args...); }
