...
namespace common::io
{
FileOutputStream::FileOutputStream(const std::string& name, const bool append = false) {
...
FileOutputStream::FileOutputStream(const char* name, const bool append = false) : FileOutputStream(std::string(name), append) {}

FileOutputStream::FileOutputStream(const std::filesystem::path& file, const bool append = false) : FileOutputStream(file.string(), append) {}
...
void FileOutputStream::write(const std::vector<char>& buffer) {
...
void FileOutputStream::write(const std::vector<char>& buffer, const size_t offset, const size_t len) {
	...
	fileStream_.write(buffer.data() + offset, static_cast<std::streamsize>(len));
}
