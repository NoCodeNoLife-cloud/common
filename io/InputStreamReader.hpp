...
#ifndef INPUTSTREAMREADER_HPP
#define INPUTSTREAMREADER_HPP
...
{
public:
	explicit InputStreamReader(std::unique_ptr<AbstractReader> input);
	explicit InputStreamReader(std::unique_ptr<AbstractReader> input, const std::string& charsetName);
