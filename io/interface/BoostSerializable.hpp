...
#ifndef BOOSTSERIALIZABLE_HPP
#define BOOSTSERIALIZABLE_HPP
...
template <typename T> class BoostSerializable abstract
{
public:
	virtual ~BoostSerializable() = default;
...
template <typename T> template <class Archive> void BoostSerializable<T>::serialize(Archive& archive, const unsigned int version) { static_cast<T*>(this)->serializeImpl(archive, version); }
} // namespace common::interface
#endif // BOOSTSERIALIZABLE_HPP
