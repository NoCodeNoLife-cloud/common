...
#ifndef BOOSTSERIALIZER_HPP
#define BOOSTSERIALIZER_HPP
#include <sstream>
#include <boost/archive/binary_iarchive.hpp>
#include <boost/archive/binary_oarchive.hpp>
#include "io/interface/BoostSerializable.hpp"

namespace common::io::serialize
{
template <typename T>concept DerivedFromBoostSerializable = std::is_base_of_v<interface::BoostSerializable<T>, T>;
