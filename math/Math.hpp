...
namespace common::math
{
	...
	/// \details This abstract class offers a variety of static methods for performing mathematical operations such as trigonometric, logarithmic, and exponential calculations.
	/// It also includes utility functions for rounding, finding absolute values, and generating random numbers.
	/// The Math class is designed to be a comprehensive library for mathematical computations.
	class Math abstract
	{
	public:
	...
	template <typename T>
	T Math::max(T a, T b) { return (a > b) ? a : b; }
	...
	template <typename T>
	T Math::min(T a, T b) { return (a < b) ? a : b; }
} // util
#endif //MATH_HPP
