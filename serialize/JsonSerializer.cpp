...
namespace common::serialize
{
	...
	/// \param key the key of the field.
	/// \param value the value of the field.
	/// \details This function serializes a field into a JSON object. It takes a JSON writer and a key-value pair as parameter.
	/// The key is the name of the field in the JSON object and the value is the value of that field. The JSON writer is used to write the key-value pair into the JSON object.
