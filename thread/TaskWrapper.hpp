...
namespace common::thread
{
	...
	class TaskWrapper final : public interface::Runnable<ReturnType, Args...>
	{
	public:
	...
	template <typename ReturnType, typename... Args>
	auto TaskWrapper<ReturnType, Args...>::SetMainFunction(std::function<ReturnType(Args...)> func) -> void
	{
	...
	template <typename ReturnType, typename... Args>
	auto TaskWrapper<ReturnType, Args...>::SetThenFunction(std::function<void()> then) -> void
	{
